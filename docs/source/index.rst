.. ChenFliessSeries.jl_docs documentation master file, created by
   sphinx-quickstart on Thu Sep  4 00:25:52 2025.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

ChenFliessSeries.jl Documentation
========================

Welcome to the documentation of the **ChenFliessSeries.jl** Julia package.

**ChenFliessSeries.jl** is used for the computation of Chen-Fliess series
